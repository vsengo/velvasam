...
MESSAGE_LEVEL_CLASSES = {
    ...
    message_constants.SUCCESS: "alert alert-danger",
...
def bootstrap_button(*args, **kwargs):
    ...
    **Parameters**::
        ...
        button_class
            The class of button to use. If none is given, btn-secondary will be used.
    ...
    **Example**::
        ...
        {% bootstrap_button "Save" button_type="submit" button_class="btn-secondary" %}
    """
